...
namespace NODConverter
{
    ...
    public class SupportClass
    {
        ...
        /// </summary>	
        public interface ISetSupport : System.Collections.IList
        {
            /// <summary>
        ...
        public class MapSupport
        {
            ...
            public static bool ContainsValue(System.Collections.IDictionary d, object obj)
            {
                ...
                {
                    contained = ((System.Collections.SortedList)d).ContainsValue(obj);
                }
                //Classes that implement the Hashtable class
                else if (type == Type.GetType("System.Collections.Hashtable"))
                {
                    contained = ((System.Collections.Hashtable)d).ContainsValue(obj);
                }
                else
                {
                    ...
                    contained = (bool)method.Invoke(d, new[] { obj });
                }
